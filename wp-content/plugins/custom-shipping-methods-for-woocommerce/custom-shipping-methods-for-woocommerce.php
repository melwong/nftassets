...
final class Alg_WC_Custom_Shipping_Methods {
	...
	function admin() {
		...
		require_once( 'includes/settings/class-alg-wc-custom-shipping-methods-settings-section.php' );
		$this->settings = array();
		$this->settings['general'] = require_once( 'includes/settings/class-alg-wc-custom-shipping-methods-settings-general.php' );
		// Version update
