...
final class Alg_WC_Empty_Cart_Button {
	...
	function includes() {
		// Core
		$this->core = require_once( 'includes/class-alg-wc-empty-cart-button-core.php' );
	}
	...
	function admin() {
		...
		require_once( 'includes/settings/class-alg-wc-empty-cart-button-settings-section.php' );
		$this->settings = array();
		$this->settings['general'] = require_once( 'includes/settings/class-alg-wc-empty-cart-button-settings-general.php' );
		// Version updated
		if ( get_option( 'alg_wc_empty_cart_button_version', '' ) !== $this->version ) {
	...
	function add_woocommerce_settings_tab( $settings ) {
		$settings[] = require_once( 'includes/settings/class-alg-wc-settings-empty-cart-button.php' );
		return $settings;
	}
