			...
			<td class="theme_background">
				...
				<fieldset class="background-type-switch unsplash_banner x1">
					...
					<p class="unsplash-feed unsplash-feed-3">
						...
						<br><br>
						<input type="checkbox" name="niteoCS_unsplash_feat" id="niteoCS_unsplash_feat" value="1" <?php checked( '1', get_option( 'niteoCS_unsplash_feat', '0' ) ); ?> class="regular-text code"><label for="niteoCS_unsplash_feat"><?php _e('Limit to Unsplash Featured Photos', 'cmp-coming-soon-maintenance');?></label>
					</p>
