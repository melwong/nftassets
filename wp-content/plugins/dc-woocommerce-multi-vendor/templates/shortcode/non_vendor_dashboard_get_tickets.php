<?php
/**
 * The template for ticket holders to get actual tickets. Based on templates/shortcode/non_vendor_dashboard.php
 *
...
if ($user && !in_array('dc_pending_vendor', $user->roles) && !in_array('administrator', $user->roles)) {
    ...
    echo do_shortcode('[vendor_registration_get_tickets]');
    echo '</div>';
}
