...
class WCMp_Shortcode {
    ...
    public function __construct() {
		...
		//Mel
		//To add get tickets shortcode
        add_shortcode('vendor_registration_get_tickets', array(&$this, 'wcmp_vendor_registration_get_tickets_shortcode'));
	...
	//Mel: 26/09/19. To upgrade from 3.3.4 to 3.4.3
	/**Mel
     * Render Get Tickets page
     * @return object
     */
    public static function wcmp_vendor_registration_get_tickets_shortcode() {
        self::load_class('vendor-registration-get-tickets');
        return self::shortcode_wrapper(array('WCMp_Vendor_Registration_Get_Tickets_Shortcode', 'output'));
    }
