...
class WCMp_Endpoints {
    ...
    public function init_wcmp_query_vars() {
        ...
        $this->wcmp_query_vars = apply_filters('wcmp_endpoints_query_vars', array(
			...
			, 'vendor-order-wallet' => array(
                'label' => __('Blockchain Wallet Interface', 'dc-woocommerce-multi-vendor'),
                'endpoint' => get_wcmp_vendor_settings('wcmp_vendor_order_wallet_endpoint', 'vendor', 'general', 'vendor-order-wallet')
            )
