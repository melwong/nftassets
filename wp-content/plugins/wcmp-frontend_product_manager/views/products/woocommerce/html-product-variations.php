                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 attribute-chk-option form-group-wrapper">
                            ...
                            <?php if ( afm_is_allowed_virtual() ) : ?>
                                <div class="form-group">
                                    <label for="variable_is_virtual[<?php echo esc_attr( $loop ); ?>]"><input type="checkbox" class="form-control variable_is_virtual" id="variable_is_virtual[<?php echo esc_attr( $loop ); ?>]" name="variable_is_virtual[<?php echo esc_attr( $loop ); ?>]" <?php checked( $variation_object->get_virtual( 'edit' ), true ); ?> /> <?php esc_html_e( 'Virtualasffa', 'woocommerce' ); ?></label>
                                </div>
                            <?php endif; ?>
