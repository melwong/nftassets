<?php
/**
 * Booking range pricing template
 * Not overridable
 *
...
<tr>
	...
	<td>
		<div class="select wc_booking_pricing_type">
			<select name="wc_booking_pricing_type[<?php echo esc_attr( $index ); ?>]" class="form-control">
	...
	<div class="bookings-datetime-select-from">
		<div class="select from_day_of_week">
			<select name="wc_booking_pricing_from_day_of_week[<?php echo esc_attr( $index ); ?>]" class="form-control">
				<?php foreach ( $intervals['days'] as $key => $label ) : ?>
		...
		<div class="select from_month">
			<select name="wc_booking_pricing_from_month[<?php echo esc_attr( $index ); ?>]" class="form-control">
		...
		<div class="select from_week">
			<select name="wc_booking_pricing_from_week[<?php echo esc_attr( $index ); ?>]" class="form-control">
		...
		<div class="from_date">
			...
			<span class="date-inp-wrap">
				<input type="text" class="date-picker form-control" name="wc_booking_pricing_from_date[<?php echo esc_attr( $index ); ?>]" value="<?php echo esc_attr( $from_date ); ?>" />
			</span>
		</div>

		<div class="from_time">
			<input type="time" class="time-picker form-control" name="wc_booking_pricing_from_time[<?php echo esc_attr( $index ); ?>]" value="<?php
	...
	<div class="bookings-datetime-select-to">
		<div class="select to_day_of_week">
			<select name="wc_booking_pricing_to_day_of_week[<?php echo esc_attr( $index ); ?>]" class="form-control">
				<?php foreach ( $intervals['days'] as $key => $label ) : ?>
		...
		<div class="select to_month">
			<select name="wc_booking_pricing_to_month[<?php echo esc_attr( $index ); ?>]" class="form-control">
				<?php foreach ( $intervals['months'] as $key => $label ) : ?>
					<option value="<?php echo $key; ?>" <?php selected( isset( $pricing['to'] ) && $pricing['to'] == $key, true ); ?>><?php echo $label; ?></option>
				<?php endforeach; ?>
			</select>
		...
		<div class="select to_week">
			<select name="wc_booking_pricing_to_week[<?php echo esc_attr( $index ); ?>]" class="form-control">
				<?php foreach ( $intervals['weeks'] as $key => $label ) : ?>
					<option value="<?php echo $key; ?>" <?php selected( isset( $pricing['to'] ) && $pricing['to'] == $key, true ); ?>><?php echo $label; ?></option>
				<?php endforeach; ?>
			</select>
		...
		<div class="to_date">
			...
			?>
			<span class="date-inp-wrap">
				<input type="text" class="date-picker form-control" name="wc_booking_pricing_to_date[<?php echo esc_attr( $index ); ?>]" value="<?php echo esc_attr( $to_date ); ?>" />
			</span>
		</div>

		<div class="to_time">
			<input type="time" class="time-picker form-control" name="wc_booking_pricing_to_time[<?php echo esc_attr( $index ); ?>]" value="<?php
	...
	<td>
		<div class="select">
			<select name="wc_booking_pricing_base_cost_modifier[<?php echo esc_attr( $index ); ?>]" class="form-control">
	...
	<?php do_action( 'afm_bookings_after_booking_pricing_base_cost', $pricing, $id ); ?>
	</td>
	<td>
		<div class="select">
			<select name="wc_booking_pricing_cost_modifier[<?php echo esc_attr( $index ); ?>]" class="form-control">
		...
		?>" placeholder="0" class="form-control"/>
	<?php do_action( 'afm_bookings_after_booking_pricing_cost', $pricing, $id ); ?>
	</td>
