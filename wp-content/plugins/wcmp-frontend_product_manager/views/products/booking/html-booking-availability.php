...
<tr>
    ...
    <td>
        <div class="select wc_booking_availability_type">
            <select name="wc_booking_availability_type[]" class="form-control">
    ...
    <td style="border-right:0;">
        <div class="bookings-datetime-select-from">
            <div class="select from_day_of_week">
                <select name="wc_booking_availability_from_day_of_week[]" class="form-control">
                    <?php foreach ( $intervals['days'] as $key => $label ) : ?>
            ...
            <div class="select from_month">
                <select name="wc_booking_availability_from_month[]" class="form-control">
            ...
            <div class="select from_week">
                <select name="wc_booking_availability_from_week[]" class="form-control">
            ...
            <div class="from_date">
                ...
                <span class="date-inp-wrap">
                    <input type="text" class="date-picker form-control" name="wc_booking_availability_from_date[]" value="<?php echo esc_attr( $from_date ); ?>" />
                </span>
            </div>

            <div class="from_time">
                <input type="time" class="time-picker form-control" name="wc_booking_availability_from_time[]" value="<?php
    ...
    <td>
        <div class="bookings-datetime-select-to">
            <div class="select to_day_of_week">
                <select name="wc_booking_availability_to_day_of_week[]" class="form-control">
                    <?php foreach ( $intervals['days'] as $key => $label ) : ?>
            ...
            <div class="select to_month">
                <select name="wc_booking_availability_to_month[]" class="form-control">
                    <?php foreach ( $intervals['months'] as $key => $label ) : ?>
                        <option value="<?php echo $key; ?>" <?php selected( isset( $availability['to'] ) && $availability['to'] == $key, true ); ?>><?php echo $label; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="select to_week">
                <select name="wc_booking_availability_to_week[]" class="form-control">
                    <?php foreach ( $intervals['weeks'] as $key => $label ) : ?>
                        <option value="<?php echo $key; ?>" <?php selected( isset( $availability['to'] ) && $availability['to'] == $key, true ); ?>><?php echo $label; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="to_date">
                ...
                ?>
                <span class="date-inp-wrap">
                    <input type="text" class="date-picker form-control" name="wc_booking_availability_to_date[]" value="<?php echo esc_attr( $to_date ); ?>" />
                </span>
            </div>

            <div class="to_time">
                <input type="time" class="time-picker form-control" name="wc_booking_availability_to_time[]" value="<?php
    ...
    <td>
        <div class="select">
            <select name="wc_booking_availability_bookable[]" class="form-control">
    ...
    <td>
        <div class="priority">
            <input type="number" name="wc_booking_availability_priority[]" value="<?php echo esc_attr( $availability['priority'] ); ?>" placeholder="10" class="form-control" />
        </div>
    </td>
    <td class="remove"><a href="#" class="delete"><i class="wcmp-font ico-delete-icon"></i></a></td>
</tr>
