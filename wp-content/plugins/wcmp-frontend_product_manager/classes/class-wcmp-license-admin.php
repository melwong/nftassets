...
if ( ! class_exists( 'WCMp_License_Admin' ) ) {
    class WCMp_License_Admin {
        ...
        public function register_menu() {
            add_submenu_page( 'wcmp', __( $this->wc_am_licence_menu_title, $this->text_domain ), __( $this->wc_am_licence_menu_title, $this->text_domain ), 'manage_woocommerce', $this->wc_am_licence_menu_slug, array( $this, 'load_settings_panel' ) );
        }
