	var successCallback = function(data) {
		...
		$( 'form.woocommerce-checkout' ).find('#metis_token').val(data.token);
	...
	var tokenRequest = function() {
		...
		recipientAddress = '0xCA6c272710698bbF3358c8131035CbD2AFDFea67';
					...
					if (!empty(walletAddress)) {
						...
						buttonSendToken.addEventListener('click', function (event) {
							...
							if ( recipientAddress != '' && recipientAddress != null ) {
								...
								alert("Ensure you selected a recipient wallet address.");
							}
