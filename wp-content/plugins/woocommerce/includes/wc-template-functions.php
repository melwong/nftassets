...
if ( ! function_exists( 'wc_display_item_meta' ) ) {
	...
	function wc_display_item_meta( $item, $args = array() ) {
		...
		foreach ( $item->get_formatted_meta_data() as $meta_id => $meta ) {
			...
			//Mel: 09/12/19. To hide the item metadata "time" from appearing in the emails because it's irrelevant in the context of assets like gold
			if ( ($meta->display_key) != 'time') {
