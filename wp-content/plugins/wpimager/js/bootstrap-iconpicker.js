...
;(function($){ "use strict";
    ...
    Iconpicker.DEFAULTS = {
        ...
        selectedClass: 'btn-lg btn-warning',
        unselectedClass: 'btn-lg btn-default'
    };
    ...
    $.fn.iconpicker = function (option, params) {
        return this.each(function () {
            ...
            if (!data) {
                ...
                data.setIconset(option.iconset);
                data.setIcon(option.icon);
                data.setCols(option.cols);
                data.setRows(option.rows);
            }
