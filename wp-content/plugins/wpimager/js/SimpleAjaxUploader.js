...
/*!
    ...
    Modified work:  Implementing image uploading in WPImager
...
ss.SimpleUpload.prototype = {
    ...
    */
    ...
    getID: function() {
        return this._opts.data.current_layer;
    },
...
ss.IframeUpload = {
    ...
    */
    ...
    _addFiles: function( file ) {
        ...
        var layer = 0;
        //if (typeof WPImager !== "undefined")
        //    layer = WPImager.current;
        if (typeof UI !== "undefined") {
            layer = (UI.upload_to_editor_layer == -1)?WPImager.current:UI.upload_to_editor_layer;
        }
        this._queue.push({
            id: ss.getUID(),
            file: file,
        ...
        var remove = ss.addEvent( iframe, 'load', function() {
            ...
            if ( abortBtn ) {
                cancel = function() {
                    ...
                    opts.onAbort.call( self, fileObj.name, fileObj.btn, fileObj.size, fileObj.layer );
    ...
    ss.extendObj( ss.SimpleUpload.prototype, {
        ...
        */
        _errorFinish: function( fileObj, status, statusText, response, errorType, progBox, sizeBox, pctBox, abortBtn, removeAbort ) {
            ...
            this._opts.onError.call( this, fileObj.name, errorType, status, statusText, response, fileObj.btn, fileObj.size , fileObj.layer );
        ...
        */
        _finish: function( fileObj, status, statusText, response, sizeBox, progBox, pctBox, abortBtn, removeAbort ) {
            ...
            this._opts.onComplete.call( this, fileObj.name, response, fileObj.btn, fileObj.size, fileObj.layer );
            this._last( sizeBox, progBox, pctBox, abortBtn, removeAbort );
