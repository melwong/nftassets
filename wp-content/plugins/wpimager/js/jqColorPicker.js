...
//                $(elm).css('background-color') || '#FFF';
    ...
    function pointerdown(e) {
        ...
        if (this.className == "cp-xy-slider" || this.className == "cp-z-slider" || this.className == "cp-alpha") {
    ...
    function xy_slider(event) {
        if (typeof _$trigger._offset === "undefined") {
            _$trigger._offset = $(".cp-xy-slider").offset();
        }
    ...
    function z_slider(event) {
        if (typeof _$trigger._offset === "undefined") {
            _$trigger._offset = $(".cp-z-slider").offset();
        }
    ...
    function alpha(event) {
        if (typeof _$trigger._offset === "undefined") {
            _$trigger._offset = $(".cp-alpha").offset();
        }
    ...
    $.fn.colorPicker = function (options) {
        ...
        $(options.body).off('.tcp').on(_pointerdown, function (e) {
            var targetLen = $(_$UI).find(e.target).length;
            if (targetLen > 0) {
    ...
    $.fn.colorPicker.toggle = function () {
        _colorPicker.toggle();
    };
