...
class WPImagerFileUpload {
    public $fileName;                    // Filename of the uploaded file
    public $fileSize;                    // Size of uploaded file in bytes
    public $fileExtension;               // File extension of uploaded file
    public $fileNameWithoutExt;
    public $savedFile;                   // Path to newly uploaded file (after upload completed)
