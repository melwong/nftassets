...
class SmartContractConnector_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'smart-contract-connector'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'smart-contract-connector'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'smart-contract-connector'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'smart-contract-connector'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'smart-contract-connector');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'smart-contract-connector'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'smart-contract-connector');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'smart-contract-connector'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'smart-contract-connector') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'smart-contract-connector');
            case 'false':
                return __('false', 'smart-contract-connector');

            case 'Administrator':
                return __('Administrator', 'smart-contract-connector');
            case 'Editor':
                return __('Editor', 'smart-contract-connector');
            case 'Author':
                return __('Author', 'smart-contract-connector');
            case 'Contributor':
                return __('Contributor', 'smart-contract-connector');
            case 'Subscriber':
                return __('Subscriber', 'smart-contract-connector');
            case 'Anyone':
                return __('Anyone', 'smart-contract-connector');
        }
        return $optionValue;
    }
