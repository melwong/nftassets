...
<div class="product-extra-conditional-row product-extra-action-match-row" <?php echo $style; ?>>
	...
	<div class="product-extra-field-half">
		...
		if( ! empty( $actions ) ) { ?>
			<select class="pewc-condition-action" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_action]">
	...
	<div class="product-extra-field-half">
		...
		if( ! empty( $matches ) ) { ?>
			<select class="pewc-condition-condition" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_match]">
	...
	foreach( $item['condition_field'] as $condition ) { ?>
		<div class="product-extra-conditional-row product-extra-conditional-rule" data-condition-count="<?php echo esc_attr( $condition_count ); ?>">
			...
			<div class="product-extra-field-third">
				...
				<?php
				$fields = pewc_get_all_fields( $group );
			...
			<div class="product-extra-field-sixth">
				...
				if( $condition_field_type == 'image_swatch' || $condition_field_type == 'checkbox_group' || ( $condition_field_type == 'products' && $allow_multiple ) ) {
				...
				<select class="<?php echo $class; ?>" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_rule][<?php echo esc_attr( $condition_count ); ?>]" id="condition_rule_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>_<?php echo esc_attr( $condition_count ); ?>" data-group-id="<?php echo esc_attr( $group_id ); ?>" data-item-id="<?php echo esc_attr( $item_key ); ?>" data-condition-id="<?php echo esc_attr( $condition_count ); ?>" data-rule="<?php echo esc_attr( $rule ); ?>">
					<?php
			...
			<div class="product-extra-field-half product-extra-field-last pewc-condition-value-field">
				...
				if( $condition_field_type == 'text' ) { ?>
					<input class="pewc-condition-value pewc-condition-set-value" type="text" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_value][<?php echo esc_attr( $condition_count ); ?>]" id="condition_value_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>_<?php echo esc_attr( $condition_count ); ?>" data-group-id="<?php echo esc_attr( $group_id ); ?>" data-item-id="<?php echo esc_attr( $item_key ); ?>" data-condition-id="<?php echo esc_attr( $condition_count ); ?>" value="<?php echo esc_attr( $value ); ?>">
				<?php } else if( $condition_field_type == 'number' || $condition_field_type == 'cost' || $condition_field_type == 'quantity' || $condition_field_type == 'calculation' ) { ?>
					<input class="pewc-condition-value pewc-condition-set-value" type="number" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_value][<?php echo esc_attr( $condition_count ); ?>]" id="condition_value_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>_<?php echo esc_attr( $condition_count ); ?>" data-group-id="<?php echo esc_attr( $group_id ); ?>" data-item-id="<?php echo esc_attr( $item_key ); ?>" data-condition-id="<?php echo esc_attr( $condition_count ); ?>" value="<?php echo esc_attr( $value ); ?>">
				<?php } else if( $condition_field_type == 'select' || $condition_field_type == 'radio' || $condition_field_type == 'image_swatch' || $condition_field_type == 'products' || $condition_field_type == 'checkbox_group' ) { ?>
					<select class="pewc-condition-value pewc-condition-set-value" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_value][<?php echo esc_attr( $condition_count ); ?>]" id="condition_value_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>_<?php echo esc_attr( $condition_count ); ?>" data-group-id="<?php echo esc_attr( $group_id ); ?>" data-item-id="<?php echo esc_attr( $item_key ); ?>" data-condition-id="<?php echo esc_attr( $condition_count ); ?>">
				...
				<?php } else if( $condition_field_type == 'checkbox' ) { ?>
					...
					<input class="pewc-condition-value pewc-condition-set-value" type="hidden" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][condition_value][<?php echo esc_attr( $condition_count ); ?>]" id="condition_value_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>_<?php echo esc_attr( $condition_count ); ?>" data-group-id="<?php echo esc_attr( $group_id ); ?>" data-item-id="<?php echo esc_attr( $item_key ); ?>" data-condition-id="<?php echo esc_attr( $condition_count ); ?>" value="__checked__">
				<?php } ?>
