...
if( $status != 'valid' ) {
	pewc_license_not_valid_message();
	return;
}
	...
	<div class="product-extra-field">
		...
		<div class="pewc-fields-wrapper pewc-fields-heading">
			<div class="product-extra-field-third">
				<input type="hidden" class="pewc-id pewc-hidden-id-field" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][id]" value="pewc_group_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>">
				<input type="hidden" class="pewc-group-id pewc-hidden-id-field" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][group_id]" value="<?php echo esc_attr( $group_id ); ?>">
				<input type="hidden" class="pewc-field-id pewc-hidden-id-field" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_id]" value="<?php echo esc_attr( $item_key ); ?>">
				<label>
					<?php _e( 'Field Label', 'pewc' ); ?>
					<?php echo wc_help_tip( 'Enter a label to appear with this field', 'pewc' ); ?>
				</label>
				<input type="text" class="pewc-field-item pewc-field-label" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_label]" value="<?php echo stripslashes( $field_label ); ?>">
			</div>
			<div class="product-extra-field-third">
				<label>
				...
				<select class="pewc-field-item pewc-field-type" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_type]" id="field_type_<?php echo esc_attr( $group_id ); ?>_<?php echo esc_attr( $item_key ); ?>" data-field-type="<?php echo $type; ?>">
					<?php
			...
			<div class="product-extra-field-third pewc-field-price-wrapper">
				...
				<input type="number" class="pewc-field-item pewc-field-price" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_price]" value="<?php echo esc_attr( $field_price ); ?>" step="0.01">
			</div>
			...
			<?php // if( pewc_is_pro() ) { ?>
				<div class="pewc-fields-wrapper pewc-checkbox-group-fields">
					<div class="product-extra-field-third">
						...
						<input type="number" class="pewc-field-item pewc-field-minchecks" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_minchecks]" value="<?php echo esc_attr( $minchecks ); ?>">
					</div>
					<div class="product-extra-field-third">
						<label>
						...
						<input type="number" class="pewc-field-item pewc-field-maxchecks" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_maxchecks]" value="<?php echo esc_attr( $maxchecks ); ?>">
					</div>
		...
		<?php // } ?>
				...
				<div class="pewc-fields-wrapper pewc-products-extras">
					<div class="product-extra-field-full">
						...
						<div class="product-extra-field-two-thirds-right">
							...
							$child_product_method = apply_filters( 'pewc_filter_child_products_method', 'woocommerce_json_search_products', $post_id, $item_key );
							if( $child_product_method != 'variable_subscriptions' ) {
								...
								<select class="pewc-field-item wc-product-search pewc-field-child_products pewc-data-options" data-options="" multiple="multiple" style="width: 100%;" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][child_products][]" data-sortable="true" data-placeholder="<?php esc_attr_e( 'Choose the child products', 'pewc' ); ?>" data-action="<?php echo $child_product_method; ?>" data-include="" data-exclude="<?php echo intval( $post_id ); ?>">
									<?php
			...
			<?php // if( pewc_is_pro() ) { ?>
				<div class="pewc-fields-wrapper pewc-products-extras">
					...
					<div class="pewc-products-layout product-extra-field-third">
						...
						<select class="pewc-field-item pewc-field-products_layout" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][products_layout]">
					...
					<div class="pewc-products-quantities product-extra-field-third">
						...
						<select class="pewc-field-item pewc-field-products_quantities" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][products_quantities]">
					...
					<div class="pewc-products-select-placeholder product-extra-field-third">
						...
						<input type="type" class="pewc-field-item pewc-field-select_placeholder" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][select_placeholder]" value="<?php echo esc_attr( $placeholder ); ?>">
					</div>
					...
					<div class="pewc-allow-none product-extra-field-third product-extra-field-last">
						...
						<input <?php checked( $checked, 1, true ); ?> <?php echo $disabled; ?> type="checkbox" class="pewc-field-item pewc-checkbox-block pewc-field-allow_none" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][allow_none]" value="1">
					</div>
			...
			<?php // if( pewc_is_pro() ) { ?>
				<div class="pewc-fields-wrapper pewc-radio-image-extras">
					<div class="product-extra-field-third">
						...
						<input type="number" class="pewc-field-item pewc-number-columns" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][number_columns]" value="<?php echo esc_attr( $number_columns ); ?>" min="1" max="10" step="1">
					</div>
					<div class="product-extra-field-third">
						<?php $checked = ! empty( $item['hide_labels'] ); ?>
						<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-hide-labels" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][hide_labels]" value="1">
						<label class="pewc-checkbox-field-label">
					...
					<div class="product-extra-field-third pewc-allow-multiple-wrapper">
						...
						<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-allow-multiple" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][allow_multiple]" value="1">
						<label class="pewc-checkbox-field-label">
			...
			<?php // if( pewc_is_pro() ) {
				...
				<div class="pewc-fields-wrapper pewc-child-product-min-max-extras">
					<div class="product-extra-field-third">
						...
						<input type="number" class="pewc-field-item pewc-min-child-products" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][min_products]" value="<?php echo esc_attr( $min_products ); ?>" min="0" max="" step="1">
					</div>
					<div class="product-extra-field-third">
						...
						<input type="number" class="pewc-field-item pewc-max-child-products" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][max_products]" value="<?php echo esc_attr( $max_products ); ?>" min="0" max="" step="1">
					</div>
				</div>
			<?php // } ?>
			...
			<?php // if( pewc_is_pro() ) {
				...
				<div class="pewc-fields-wrapper pewc-child-product-discount-extras">
					<div class="product-extra-field-third">
						<?php $child_discount = ( isset( $item['child_discount'] ) ) ? intval( $item['child_discount'] ) : ''; ?>
						<label>
							<?php _e( 'Discount', 'pewc' ); ?>
							<?php echo wc_help_tip( 'Enter a discount for products purchased in this field', 'pewc' ); ?>
						</label>
						<input type="number" class="pewc-child-discount" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][child_discount]" value="<?php echo esc_attr( $child_discount ); ?>" min="0" max="" step="0.01">
					</div>
					<div class="product-extra-field-third">
						...
						<select class="pewc-field-item pewc-child-discount-type" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][discount_type]">
			...
			<div class="pewc-fields-wrapper pewc-misc-fields">
				<div class="pewc-required product-extra-field-third">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-field-required" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_required]" value="1">
					<label class="pewc-checkbox-field-label">
				...
				<div class="pewc-flatrate product-extra-field-third">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-field-flatrate" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_flatrate]" value="1">
					<label class="pewc-checkbox-field-label">
				...
				<?php if( pewc_is_pro() ) { ?>
					<div class="pewc-percentage product-extra-field-third">
						...
						<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-field-percentage" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_percentage]" value="1">
						<label class="pewc-checkbox-field-label">
			...
			<div class="pewc-fields-wrapper pewc-upload-fields">
				...
				<div class="product-extra-field-third">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-multiple-uploads" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][multiple_uploads]" value="1">
					<label class="pewc-checkbox-field-label">
				...
				<div class="product-extra-field-third pewc-ajax-upload-only">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-multiply-price" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][multiply_price]" value="1">
					<label class="pewc-checkbox-field-label">
				...
				<div class="product-extra-field-third pewc-ajax-upload-only">
					...
					<input type="number" class="pewc-field-item pewc-field-max-files" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][max_files]" min="1" value="<?php echo esc_attr( $max_files ); ?>">
				</div>
			...
			<div class="pewc-fields-wrapper pewc-char-fields">
				<div class="product-extra-field-third">
					...
					<input type="number" class="pewc-field-item pewc-field-minchars" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_minchars]" value="<?php echo esc_attr( $min_chars ); ?>">
				</div>
				<div class="product-extra-field-third">
					...
					<input type="number" class="pewc-field-item pewc-field-maxchars" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_maxchars]" value="<?php echo esc_attr( $max_chars ); ?>">
				</div>
				<div class="product-extra-field-third">
					<label class="pewc-checkbox-field-label">
					...
					<input <?php checked( $per_char_checked, 1, true ); ?> type="checkbox" class="pewc-checkbox-block pewc-field-per-character" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][per_character]" value="1">
				</div>
			</div><!-- .pewc-fields-wrapper -->
			...
			<?php // if( pewc_is_pro() ) { ?>
				<div class="pewc-fields-wrapper pewc-extrachar-fields">
					<div class="product-extra-field-third">
						...
						<input type="number" min="0" class="pewc-field-item pewc-field-freechars" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_freechars]" value="<?php echo esc_attr( $field_freechars ); ?>">
					</div>
					<div class="product-extra-field-third">
						<label class="pewc-checkbox-field-label">
						...
						<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-checkbox-block pewc-field-alphanumeric" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_alphanumeric]" value="1">
					</div>
					<div class="product-extra-field-third">
						<label class="pewc-checkbox-field-label">
						...
						<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-checkbox-block pewc-field-alphanumeric-charge" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_alphanumeric_charge]" value="1">
					</div>
				</div><!-- .pewc-fields-wrapper -->
			<?php //} ?>
			...
			<div class="pewc-fields-wrapper pewc-num-fields">
				<div class="product-extra-field-third">
					<?php $field_minval = ! empty( $item['field_minval'] ) ? $item['field_minval'] : ''; ?>
					<label>
						<?php _e( 'Min Value', 'pewc' ); ?>
						<?php echo wc_help_tip( 'An optional minimum value for the field', 'pewc' ); ?>
					</label>
					<input type="number" class="pewc-field-item pewc-field-minval" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_minval]" value="<?php echo esc_attr( $field_minval ); ?>">
				</div>
				<div class="product-extra-field-third">
					...
					<input type="number" class="pewc-field-item pewc-field-maxval" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_maxval]" value="<?php echo esc_attr( $field_maxval ); ?>">
				</div>
				<div class="product-extra-field-third">
					<label class="pewc-checkbox-field-label">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-checkbox-block pewc-field-multiply" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][multiply]" value="1">
				</div>
			</div><!-- .pewc-fields-wrapper -->
			...
			<div class="pewc-fields-wrapper pewc-date-fields">
				<div class="product-extra-field-third">
					...
					<input <?php checked( $checked, 1, true ); ?> type="checkbox" class="pewc-field-item pewc-field-min_date_today" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][min_date_today]" value="1">
				</div>
				<div class="product-extra-field-third">
					...
					<input type="text" class="pewc-field-item pewc-date-field pewc-field-mindate" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_mindate]" value="<?php echo esc_attr( $mindate ); ?>">
				</div>
				<div class="product-extra-field-third">
					...
					<input type="text" class="pewc-field-item pewc-date-field pewc-field-maxdate" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_maxdate]" value="<?php echo esc_attr( $maxdate ); ?>">
				</div>
			</div><!-- .pewc-fields-wrapper -->

			<div class="pewc-fields-wrapper pewc-default-fields">
				<?php $default = ! empty( $item['field_default'] ) ? $item['field_default'] : '';
				if( ! empty( $item['field_default_hidden'] ) ) {
				...
				<div class="pewc-default product-extra-field-third">
					<?php // if( $item['field_type'] == 'checkbox' ) {
						...
						<input <?php checked( $default, 'checked', true ); ?> type="checkbox" class="pewc-field-item pewc-field-default pewc-field-default-field-checkbox" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_default]" value="1">
					...
					<?php // } else if( $item['field_type'] == 'number' ) { ?>
						...
						<input type="number" class="pewc-field-item pewc-field-default pewc-field-default-field-number" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_default]" value="<?php echo esc_attr( $default ); ?>">
					<?php // } else { ?>
						<label class="pewc-checkbox-field-label pewc-field-default-field-text">
							<?php _e( 'Default', 'pewc' ); ?>
							<?php echo wc_help_tip( 'Enter a default value', 'pewc' ); ?>
						</label>
						<input type="text" class="pewc-field-item pewc-field-default pewc-field-default-field-text" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_default]" value="<?php echo esc_attr( $default ); ?>">
					<?php // }
					$default_hidden = isset( $item['field_default_hidden'] ) ? $item['field_default_hidden'] : ''; ?>
					<input type="hidden" class="pewc-field-item pewc-field-default pewc-field-default-hidden" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_default_hidden]" value="<?php echo esc_attr( $default_hidden ); ?>">
				</div>
			</div><!-- .pewc-fields-wrapper -->
			...
			<div class="pewc-fields-wrapper pewc-desc-image-wrapper">
				...
				<div class="product-extra-field-third pewc-field-image <?php echo join( ' ', $image_wrapper_classes ); ?>">
					...
					<input type="hidden" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_image]" class="pewc-field-item pewc-image-attachment-id" value="<?php echo esc_attr( $field_image ); ?>">
				</div>
				<div class="product-extra-field-two-thirds-right pewc-description">
					...
					<textarea class="pewc-field-item pewc-field-description" name="_product_extra_groups[<?php echo esc_attr( $group_id ); ?>][items][<?php echo esc_attr( $item_key ); ?>][field_description]"><?php echo esc_html( $description ); ?></textarea>
				</div>
			</div><!-- .pewc-fields-wrapper -->
