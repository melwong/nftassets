	...
	<div class="product-extra-field">
		...
		<div class="pewc-fields-wrapper pewc-fields-heading">
			...
			<div class="product-extra-field-third pewc-field-price-wrapper">
				...
				<input type="number" class="pewc-field-item pewc-field-price" name="" value="" step="0.01">
			</div>
		</div>
		...
		<div class="pewc-hide-if-not-pro">
			...
			<div id="" class="pewc-fields-wrapper pewc-option-fields">
				<div>
					<div class="product-extra-field-45">
				...
				<div class="pewc-field-options-wrapper pewc-data-options" data-options='[]'>
				</div>
				<p><a href="#" class="button add_new_option"><?php _e( 'Add Option', 'pewc' ); ?></a></p>
				<p class="pewc-select-field-only">
					<input type="checkbox" class="pewc-first-field-empty" name="" value="1">
					<label class="pewc-checkbox-field-label">
						<?php _e( 'First field is instruction only', 'pewc' ); ?>
						<?php echo wc_help_tip( 'Select this if your first option is an instruction to the user, e.g. "Pick an item"', 'pewc' ); ?></label>
				</p>
