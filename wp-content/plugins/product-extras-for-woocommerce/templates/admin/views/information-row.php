...
if( ! isset( $group_id ) ) {
	...
	$name_image = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][field_rows][' . $row_count . '][image]';
	$name_label = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][field_rows][' . $row_count . '][label]';
	$name_data = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][field_rows][' . $row_count . '][data]';
}  ?>
