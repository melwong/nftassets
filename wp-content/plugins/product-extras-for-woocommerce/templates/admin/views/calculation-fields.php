...
if( ! isset( $item_key ) ) {
	...
	$name = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][formula]';
	$formula_action_name = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][formula_action]';
	$round_name = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][formula_round]';
	$decimals_name = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][decimal_places]';
	$hidden_name = '_product_extra_groups[' . $group_id . '][items][' . $item_key . '][hidden_calculation]';
}
