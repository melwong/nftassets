 ...
 * Set import files
 */
function lawworx_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'lawworx'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'lawworx_set_import_files' );

/**
 * Define actions that happen after import
 */
function lawworx_actions_after_import() {
    ...
    update_option( 'blogname', 'Lawworx' );
...
add_action( 'pt-ocdi/after_import', 'lawworx_actions_after_import' );
