		...
		<?php if ( have_posts() ) : ?>
			...
			<?php woocommerce_product_loop_start(); ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php wc_get_template_part( 'content', 'product-search' ); //referring to themes/myticket/woocommerce/content-product-search.php ?>
			...
			<?php global $wp_query; myticket_pagination( $wp_query ); ?> 
