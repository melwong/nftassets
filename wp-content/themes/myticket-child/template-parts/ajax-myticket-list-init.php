...
if ( ! function_exists( 'myticket_filter_list_ajax' ) ) {
    function myticket_filter_list_ajax() {
		...
		//Mel: 13/08/19. Ref: https://codex.wordpress.org/Function_Reference/get_stylesheet_directory
		require get_stylesheet_directory() . '/template-parts/ajax-myticket-list.php';
