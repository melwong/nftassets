<?php
/*
Widget Name: MyTicket Upcomming Events Widget
...
class myticket_events_upcomming_widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            'myticket_events_upcomming_widget',

            // The name of the widget for display purposes.
            esc_html__('MyTicket Upcomming Events', 'myticket'),

            // The $widget_options array, which is passed through to WP_Widget.
            // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
            array(
                'description' => esc_html__('Create Upcomming Events Section', 'myticket'),
    ...
    function get_template_name($instance) {
        return 'myticket-events-upcomming';
    }
...
siteorigin_widget_register('myticket_events_upcomming_widget', __FILE__, 'myticket_events_upcomming_widget');
