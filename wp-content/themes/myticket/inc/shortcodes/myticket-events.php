...
class myticket_events_widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            'myticket_events_widget',

            // The name of the widget for display purposes.
            esc_html__('MyTicket Events List', 'myticket'),
...
siteorigin_widget_register('myticket_events_widget', __FILE__, 'myticket_events_widget');
