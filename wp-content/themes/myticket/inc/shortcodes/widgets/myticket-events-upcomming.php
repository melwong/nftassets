    ...
    <div class="container">
        <div class="row">
            ...
            $myticket_args = array(
                ...
                'meta_query' => array(),
				//Mel: 20/08/19. Added when upgraded to theme 1.0.7.
                //'tax_query' => array('relation'=>'AND'),  
                'meta_key' => 'myticket_datetime',
                'orderby' => 'meta_value_num',
                'order' => 'ASC',
				//Mel: 20/08/19. Added when upgraded to theme 1.0.7. To stop the display of "hidden" products (Catalog visibility: hidden)
				'tax_query'         => array(
					'relation'      => 'AND',
					array(
