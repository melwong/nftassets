...
//Mel: 05/10/19. To change the PDF filename from like "Claragonwww1krowd1stwp-contentuploadstickets13019.pdf" to "13019.pdf". Currently the ticket PDFs are saved in application root folder
$file                           = sanitize_file_name($order_id.".pdf");
//$file                           = sanitize_file_name($ticketDir."/".$order_id.".pdf");

//Mel: 04/10/19. Grab the main theme color to match it with ticket 
...
<!--Mel: 04/10/19. Took the template from ticket individual design and use it here -->
<div class="title">

	<div class="watermark">
		<h2 class="rubber-stamp"><?php echo esc_html__( 'Your Receipt', 'myticket' ); //echo esc_html__( 'Your Virtual Ticket', 'myticket' ); ?></h2>
	</div>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr class="item">
		<td width="50%">
			...
			<?php
			//Mel: 11/12/19. To remove for assets use
			//printf( esc_html__( 'Date & Time: %s', 'myticket' ), esc_html($myticket_time) );
			//printf( '<br />' );
			printf( esc_html__( 'Venue: %s', 'myticket' ), esc_html($myticket_venue) );
			printf( '<br />' );
			printf( esc_html__( 'Address: %s', 'myticket' ), esc_html($myticket_address) );
			printf( '<br />' );
...
?>
	...
	<table class="new" style="background-image: url('<?php //Mel: 05/11/19 do_action('get_upload_dir', 'baseurl', '/2019/07/milky-way-1024x575.jpg'); ?>');">
		<tr>
			<td class="img">
				<img class="product-img" src="<?php echo $attachment[0]; ?>">
			</td>
			<td class="ticket-details">
				<table class="inside">
					...
					<tr>
						<td class="ticket">
							<h3 class="address"><?php echo esc_html__( 'Secured Storage Location', 'myticket' ); ?></h3>
						</td>
					</tr>
					<tr>
						<td class="ticket">
							<h4 class="address"><?php echo esc_attr( $myticket_venue ); ?></h4>
						</td>
					</tr>
					<tr>	
						<td class="ticket">
							<h4 class="address"><?php echo esc_attr( $myticket_address ); ?></h4>
						</td>
					</tr>
					<tr>
						<td class="ticket">
							<h6 class="time"><?php //echo esc_attr( $myticket_time ); //Mel: 05/11/1. To remove for assets use ?></h6>
						</td>								
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td class="button">
							<h6 class="time">
								<?php printf( esc_html__( 'Smart Contract Address: %s', 'myticket' ), $smart_contract_address); ?>
							</h6>
						</td>
					</tr>
				</table>	
...
<table cellpadding="0" cellspacing="0">
	...
	<tr class="item">
		<td width="50%">
			...
			<?php
			//Mel: 11/12/19. To remove for use with assets
			//printf( esc_html__( 'Date & Time: %s', 'myticket' ), esc_html($myticket_time) );
			//printf( '<br />' );
			printf( esc_html__( 'Venue: %s', 'myticket' ), esc_html($myticket_venue) );
			printf( '<br />' );
...
//Mel: 04/10/19. To display the selected options by the customer in the parent product
