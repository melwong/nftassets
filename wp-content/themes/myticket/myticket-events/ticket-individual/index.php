...
<div class="title">
	...
	<div class="watermark">
		<h2 class="rubber-stamp"><?php echo esc_html__( 'Your Receipt', 'myticket' ); //echo esc_html__( 'Your Virtual Ticket', 'myticket-events' ); ?></h2>
	</div>
...
<?php
	...
	//Mel: 28/11/2019
	$smart_contract_address = get_post_meta( $product_id, 'smart_contract_address', true );
			...
			?>
				<tr class="item">
					<td width="50%">
						...
						<?php
						//Mel: 05/11/19. To remove for assets use
						...
						printf( '<br />' );
						printf( '<br />' );
						printf( esc_html__( 'Order Date: %s', 'myticket' ), date_i18n( get_option('date_format'), strtotime($order->get_date_created()) ) );
						printf( '<br />' );
						printf( esc_html__( 'Order Number: %s', 'myticket' ), esc_html($order_id) );
						printf( '<br />' );
