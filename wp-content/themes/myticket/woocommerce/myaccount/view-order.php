...
<?php //Mel: 20/08/19. Added when upgraded to latest 1.0.7 theme. 
//echo do_shortcode( '[bewpi-download-invoice class="primary-link" title="Download Ticket" order_id="' . $order_id . '"]' ); ?>

<!--Mel: 20/08/19. Added when upgraded to latest 1.0.7 theme. To change the ticket download mechanism to be like our thankyou.php-->
<?php
